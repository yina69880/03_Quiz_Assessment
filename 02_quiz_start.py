...
class Start:
    def __init__(self):
        ...
        # quiz heading text
        self.start_text = Label(self.start_frame, text="Legendary Figures Quiz", font=("Arial", "16", "bold"))
        self.start_text.grid(row=0, pady=5)

        # instructions text

        self.instructions_text = Label(self.start_frame, text="Welcome to my Mythological figures quiz game",
                                       font=("Arial", "9"))
